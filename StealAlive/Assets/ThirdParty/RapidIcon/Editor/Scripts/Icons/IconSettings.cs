...
namespace RapidIcon_1_7_2
{
	...
	public class IconSettings
	{
		...
		public IconSettings(Shader objRenderShader, string rapidIconRootFolder, GameObject rootObject)
		{
			//---Initialise Icon---//
			//Object Settings
			objectPosition = new Vector3(0, -0.33f, -0.4f); // Vector3.zero;
			objectRotation = new Vector3(-30, 100f, 17f); // Vector3.zero;
			...
			//Camera Settings
			cameraPosition = new Vector3(-0.8f, 0.6f, 0.45f); // new Vector3(1, Mathf.Sqrt(2), 1);
			perspLastScale = 1;
			cameraOrtho = false;
			cameraFov = 40;
			cameraSize = 5;
			...
			//Export Settings
			exportResolution = new Vector2Int(512, 512);
